...
val WHITE_KINGSIDE_CASTLE: MoveAction = MoveAction(Pair(KING_HOME_FILE, 0), Pair(KINGSIDE_KING_DESTINATION_FILE, 0), Piece.EMPTY)
val WHITE_QUEENSIDE_CASTLE: MoveAction = MoveAction(Pair(KING_HOME_FILE, 0), Pair(QUEENSIDE_KING_DESTINATION_FILE, 0), Piece.EMPTY)
val BLACK_KINGSIDE_CASTLE: MoveAction = MoveAction(Pair(KING_HOME_FILE, GRID_SIZE-1), Pair(KINGSIDE_KING_DESTINATION_FILE, GRID_SIZE-1), Piece.EMPTY)
val BLACK_QUEENSIDE_CASTLE: MoveAction = MoveAction(Pair(KING_HOME_FILE, GRID_SIZE-1), Pair(QUEENSIDE_KING_DESTINATION_FILE, GRID_SIZE-1), Piece.EMPTY)

fun castleMove(color: Boolean, side: Boolean): MoveAction? {
    return when {
